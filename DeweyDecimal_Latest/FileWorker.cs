    ...
    public class FileWorker
    {
        ...
        private void ProcessLevel3Click(Node selectedNode)
        {
            ...
            if (isCorrect)
            {
                ...
                OnGameCompleted();
                control.SetLabelCorrect();
                control.UpdateLabelText("It looks like you know your Dewey Decimal classifications!");
                var message = MessageBox.Show("Would you like to play again?\nPlay again to beat your personal best.", "Play again", MessageBoxButtons.YesNo, MessageBoxIcon.Information);
            ...
            else
            {
                HandleLives();
                control.SetLabelError();
                control.UpdateLabelText("No more lives left...");
